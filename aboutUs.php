	...
	<div class = "container">
		<div class = "maincontent">
			...
			<div class="row visible-on">
				...
				<div class="col-lg-8 col-lg-offset-1"><h3 style="text-align: center;">Tanner Dodrill</h3>
				<p>Tanner Dodrill is pursuing his second and third degrees in Applied Computing Technology and Sociology. 
				He did nuclear treaty monitoring for the Air Force, has his BA in Anthropology, and reads too much.</p></div>
				<div class ="col-lg-1"><img src="images/tanner.jpg" alt="images/tanner" width="100"></div>
			</div>
		...
		<div class="row visible-on">
				<!-- 1st Column stretching 6 Grid Blocks -->
				<div class="col-lg-8 col-lg-offset-1"><h3 style="text-align: center;">Brad Bovaird</h3>
				<p>Brad Bovaird is a senior at CSU. His major is Applied Computing Technology
				with a concentration in Computing Technology. He enjoys cooking, fly-fishing, sports, and anything
				outdoors.</p></div>
				<div class ="col-lg-1"><img src="images/Brad.jpg" alt="Brad" width="100"></div>
		</div>
